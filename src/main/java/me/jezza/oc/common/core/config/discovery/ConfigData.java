...
import me.jezza.oc.api.config.Config.IConfigRegistrar;
...
public class ConfigData {
    ...
    public void processConfigContainers(ASMDataTable dataTable, Collection<ICEFactory<?, ? extends ConfigEntry<? extends Annotation, ?>>> annotationMap) {
        for (ConfigContainer configContainer : containerMap.values()) {
            configContainer.processAllClasses(dataTable, annotationMap);
